  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "!pip install meeko gemmi pdbfixer streamlit py3Dmol stmol matplotlib pyyaml pandas scipy numpy\n",
        "\n",
...
def zipdir(path, ziph):
    for root, dirs, files in os.walk(path):
        # Exclude unnecessary/heavy folders
        if any(exclude in root for exclude in ['.git', '__pycache__', 'results', '.gemini']):
            continue
        for file in files:
